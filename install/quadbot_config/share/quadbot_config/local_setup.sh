...
: ${AMENT_CURRENT_PREFIX:="/home/ibrahim/ChampQuadbot/install/quadbot_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/quadbot_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/quadbot_config/environment/path.sh"
