...
def generate_launch_description():
    ...
    # no-rays variant of the robot (sets lidar_visualize:=false)
    default_model_path = os.path.join(
        descr_pkg_share, "urdf/robot_no_lidar_viz.urdf.xacro"
    )
    ...
    # spawn slightly above standing height so it settles onto the ground plane
    ...
    gazebo_ld = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            # same gui:=false -> headless:=True translation as gazebo.launch.py
